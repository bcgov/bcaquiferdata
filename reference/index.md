...
- [`data_update()`](https://bcgov.github.io/bcaquiferdata/reference/data_update.md)
  : Update cached data
- [`cache_clean()`](https://bcgov.github.io/bcaquiferdata/reference/cache_clean.md)
  : Clean cache
...
- [`wells_eg_fixed`](https://bcgov.github.io/bcaquiferdata/reference/wells_eg_fixed.md)
  : wells_eg_fixed
- [`wells_eg_unfixed`](https://bcgov.github.io/bcaquiferdata/reference/wells_eg_unfixed.md)
  : wells_eg_unfixed
...
- [`lith_fix()`](https://bcgov.github.io/bcaquiferdata/reference/lith_fix.md)
  : Fix lithology descriptions
- [`fix_depth_mismatch()`](https://bcgov.github.io/bcaquiferdata/reference/fix_depth_mismatch.md)
  : Fix the depth of the well if not equal to final lithology
- [`fix_yield_zero()`](https://bcgov.github.io/bcaquiferdata/reference/fix_yield_zero.md)
...
- [`drawdown()`](https://bcgov.github.io/bcaquiferdata/reference/drawdown.md)
  : Create Excel Drawdown template file

## Data

- [`tiles`](https://bcgov.github.io/bcaquiferdata/reference/tiles.md) :
  tiles
- [`flags`](https://bcgov.github.io/bcaquiferdata/reference/flags.md) :
  Flags
