...
fields_wells <- c(
  ...
  "water_depth_m",
  "well_depth_m",
  "total_depth_drilled_ft_bgl",
  "finished_well_depth_ft_bgl",
  "bedrock_depth_ft_bgl",
  "ground_elevation_ft_asl",
  "static_water_level_ft_btoc",
  "well_yield_usgpm",
  "well_yield_unit_code",
  "artesian_flow_usgpm",
  "artesian_pressure_psi",
  "water_quality_colour",
  "water_quality_odour",
  "yield_estimation_rate_usgpm",
  "static_level_before_test_ft_btoc",
  "drawdown_ft_btoc",
  "aquifer_id",
  "storativity",
  "transmissivity_m_2_s",
  "hydraulic_conductivity_m_s",
  "specific_storage_1_m",
  "specific_yield",
  "aquifer_lithology_code",
  "artesian_pressure_head_ft_agl",
  "artesian_conditions"
)

fields_lith_gwells <- c(
  "well_tag_number",
  "lithology_from_ft_bgl",
  "lithology_to_ft_bgl",
  "lithology_raw_data",
  "lithology_description_code",
  "lithology_material_code",
