...
other analyses (e.g., Strater, Voxler, ArcHydro, Leapfrog).

The functions provided here allow users to filter GWELLS data by region (shapefile),
calculate and add elevation data from Lidar and/or TRIM (or a custom DEM),
and clean and categorize GWELLS lithology and yield data. 

The Shiny app (a browser-based graphical user interface), provides a tool for data exploration
and exporting.

We're still actively refining and adding to this tool, but it is maturing.
See the [bcaquiferdata website](https://bcgov.github.io/bcaquiferdata) for 
